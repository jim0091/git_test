 ...
 */
    ...
    class AdminModel extends CommonModel{
    	public function __construct(){
    		$this->modelAdmin=M('supplier_user');
        ...
        public function adminLogin($userName){
	        ...
	        return $this->modelAdmin->where($condition)->find();
        }
    	
    	public function getAdminInfo($id){
    		$condition='businessId='.$id;
    	...
    	public function changePass($adminId,$data){
			 ...
			 * 查找一条管理员信息
			 * */
			public function getThisAdminInfo($uId){
				return $this->modelAdmin->where('admin_id='.$uId)->find();
