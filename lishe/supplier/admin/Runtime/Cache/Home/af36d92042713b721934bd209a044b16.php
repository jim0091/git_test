...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">已发货订单</span></div>
    </div>
            ...
            <div class="result-content">
                <table class="result-tab" min-width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>已发货，待入库</td>
                            <td><a href="javascript::" onclick="layer_show('查看','<?php echo U('Home/orderDetail/',array('order_id'=>$val['order_id']));?>','1','800','500')">详情 </a></td>
