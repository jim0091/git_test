...
<div class="main-wrap">
    ...
    <div class="search-wrap">
		...
		<form action="<?php echo U('Order/index');?>" method="get" id="serach">
			...
			<div class="product-tools">
				...
				<input type="text" onfocus="WdatePicker()" value="<?php echo ($searchData["endTime"]); ?>" name="endTime" id="datemax" class="input-text Wdate" style="width:120px;">
					...
					<?php if(!empty($searchData["status"])): ?><option value="<?php echo ($searchData["status"]["status"]); ?>"><?php echo ($searchData["status"]["name"]); ?></option><?php endif; ?>						
