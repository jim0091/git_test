...
class topc_ctl_member_trade extends topc_ctl_member {
	...
	public function activityTradeList()
    {
    	header("location:/shop.php/Activity/orderList");
    }
