...
class topshop_ctl_promotion_package extends topshop_controller {
    ...
    public function edit_package()
    {
        ...
        if($apiData['package_id'])
        {
            ...
            $packageItemList = $objMdlPackageItem->getList('item_id,package_price', array('package_id'=>$apiData['package_id'] ) );
            $packageItems = array_column($packageItemList, 'item_id');
    ...
    public function searchItem()
    {
        ...
        {
            $objMdlPackageItem = app::get('syspromotion')->model('package_item');
            $notEndItem = $objMdlPackageItem->getList('item_id', array('end_time|than'=>time() ) );
