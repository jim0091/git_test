...
class topshop_ctl_trade_list extends topshop_controller{
    ...
    public function search()
    {
        ...
        $params = array(
            ...
            'fields' =>'order.aftersales_status,order.disabled,order.spec_nature_info,tid,shop_id,user_id,status,order_status,payment,points_fee,total_fee,post_fee,payed_fee,receiver_name,trade_memo,created_time,receiver_mobile,discount_fee,adjust_fee,order.title,order.price,order.num,order.pic_path,order.tid,order.oid,order.item_id,need_invoice,invoice_name,invoice_type,invoice_main,pay_type,cancel_status',
        );
