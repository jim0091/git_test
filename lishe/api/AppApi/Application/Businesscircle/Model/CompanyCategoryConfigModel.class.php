 ...
 * +----------------------------------------------------------------------
 * |@Name:			[CompanyCategoryConfigModel.class.php];	
 * +----------------------------------------------------------------------
...
namespace Businesscircle\Model;
use Think\Model;
class CompanyCategoryConfigModel extends Model
{
	 
	protected $pk = 'cat_config_id';
	protected $autoinc = true;
	protected $trueTableName = 'company_category_config';
