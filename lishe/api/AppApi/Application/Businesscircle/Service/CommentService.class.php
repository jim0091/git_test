...
class CommentService extends Controller {
	...
	public function plusCommentNum($businesscircle_id){
	...
	public function subtractCommentNum($businesscircle_id){
		$ModelObj = D('Businesscircle');
		$where['id'] = $businesscircle_id;
