...
for(var i=0; i<likes.length; i++){
	...
	likes[i].addEventListener("touchstart", function(){
		if(likeArr[this.index] == false){
			//this.querySelectorAll(".heart")[0].style.backgroundImage = "url(/Public/Home/Giftrecord/images/heart_red.png)";
			...
			//this.querySelectorAll(".heart")[0].style.backgroundImage = "url(/Public/Home/Giftrecord/images/heart_gray.png)";
			//var new_liked_num = parseInt(this.querySelectorAll(".like_num")[0].innerHTML);
			//this.querySelectorAll(".like_num")[0].innerHTML = new_liked_num - 1;
...
if(follow){
	follow.addEventListener("touchstart", function(){
		if(followed==false){
			//follow.style.backgroundImage = "url(/Public/Home/Giftrecord/images/followed.png)";
			//followed = true;
		}else{
			//follow.style.backgroundImage = "url(/Public/Home/Giftrecord/images/follow.png)";
			//followed = false;
		}
	}, false);
}
