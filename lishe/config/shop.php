...
return array(
    ...
    'trade' => array(
        ...
        'menu' => array(
            ...
            array('label'=>'修改订单价格页面','display'=>false,'as'=>'topshop.trade.modifyPrice','action'=>'topshop_ctl_trade_list@modifyPrice','url'=>'modifyprice.html','method'=>'get','middleware'=>['topshop_middleware_developerMode']),
            array('label'=>'保存修改订单价格','display'=>false,'as'=>'topshop.trade.modifyPrice.post','action'=>'topshop_ctl_trade_list@updatePrice','url'=>'updateprice.html','method'=>'post','middleware'=>['topshop_middleware_developerMode']),
    ...
    'item' => array(
        ...
        'menu' => array(
            ...
            array('label'=>'创建商品','display'=>false,'as'=>'topshop.item.create','action'=>'topshop_ctl_item@storeItem','url'=>'item/storeItem.html','method'=>'post','middleware'=>['theme_middleware_rsftockens']),
