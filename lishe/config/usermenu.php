...
return array(
    array(
        ...
        'items' => array(
            ...
            array('label' => '活动订单','action'=>'topc_ctl_member_trade@activityTradeList'),
    ...
    array(
        'label' => '我的信息',
        'items' => array(
            array('label' => '我的礼舍币','action'=>'topc_ctl_member_point@point'),
    ...
    array(
        ...
        'items' => array(
            ...
            array('label' => '我的福利积分','action'=>'topc_ctl_member_deposit@view'),
        ),
    ),
);
