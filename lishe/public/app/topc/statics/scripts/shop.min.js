...
b){return this.show(a,"success",b)},error:function(a,b){return this.show(a,"error",b)}});var passwordStrength=function(a,b,c){var d=/[A-Z]/g,e=RegExp("(.{"+parseInt(a.length/2)+",})","g"),l="poor",l=-1,l=!a||5>a.length?-1:parseInt(a.length/5)-1;a.match(e)&&l--;(a.match(/[a-z]/g)||a.match(d))&&l++;a.match(/\d/g)&&l++;a.match(/[\W_]/g)&&l++;5<a.length&&2>l&&l++;switch(l){case -1:case 0:case 1:l="poor";break;case 2:l="weak";break;case 3:l="good";break;default:l="strong"}b.className=(c?c+" ":"")+"password-"+l};
passwordStrength.init=function(a,b){$(a).each(function(a,d){if(d&&(b=b?$(d.parentNode).find(b):$(d).next())){var e=b[0].className;$(d).on("input propertychange",function(a){"propertychange"===a.type&&a.propertyName&&"value"!==a.propertyName.toLowerCase()||(a=this.value,passwordStrength.prev!==a&&passwordStrength(a,b[0],e),passwordStrength.prev=a)})}})};
function changeVerify(a,b){$(a).each(function(a){a=$(this);var d,e;"IMG"===this.tagName?(e=$(this),d=a.attr("src")):(e=a.siblings("img"),d=a.attr("href"));if(b)a.on("click",function(){changeCode(e,d)});else changeCode(e,d)})}function changeCode(a,b){b=b||a.attr("src");var c=+new Date,d=b.match(/\b_=([\d]+)\b/);b=d?b.replace(d[1],c):b+((-1<b.indexOf("?")?"&":"?")+"_="+c);a.attr("src",b);return!1}function checkAll(a,b){$(b).prop("checked",$(a).prop("checked"))}
...
b){return $(a).find("select").every(function(a){var b=a.value;return $(a).is(":visible")?""!=b&&"_NULL_"!=b:!0})}],equalto:["两次填写不一致",function(a,b,c,d,e){a=$(d).find('[name="'+e+'"]');return!a[0]||b===a.val()}],oneoftwo:["请至少填写一项",function(a,b,c,d,e){a=$(d).find('[name="'+e+'"]');return!a[0]||b||a.val()}],onerequired:["请至少选择一项",function(a,b,c,d){a=a.name;return $(d).find("input:checked[type="+c+"]"+(a?'[name="'+a+'"]':"")).length}]},validation=function(a,b){"string"===typeof b&&(b={range:b});b=$.extend({group:".form-row",
tips:{form:"inline","class":"caution"}},b||{});a=a?$(a):null;if(!a)return!0;var c=a.data("validateConfig"),d=dataOptions(a,"validate");"string"===typeof c&&(c=$.parseJSON(c));b=$.extend(b,c||{},d);a.is("form")&&a.attr("novalidate","novalidate");var e=[];(a.is("form")||"all"===b.range?a.find("[data-validate], [pattern], [type=number], [type=email], [type=tel], [type=url], [type=date], [required], [minlength], [maxlength], [data-equalto], [data-oneoftwo]"):$(a)).each(function(c){var d=$(this);if(!d.is(":visible"))return!0;
var r=[];d.attr("data-validate")&&(r=d.attr("data-validate").split(" "));d.attr("required")&&r.unshift("required");c=d.attr("data-caution")||"";var q=d.attr("pattern"),w=RegExp("^(?:"+q+")$"),z="custom_"+$.guid++;c=c?c.split(/&&|&amp;&amp;/):[];q&&(validatorMap[z]||(validatorMap[z]=[d.attr("data-attention")||"",function(a,f){return null===f||""===f||w.test(f)}]),r.push(z));$.each(["number","url","email","tel","date"],function(a,f){d.attr("type")===f&&r.push(f)});$.each(["minlength","maxlength","data-equalto",
"data-oneoftwo"],function(a,f){d.attr(f)&&r.push(f)});if(!r.length)return!0;for(var x=!1,q=0,z=r.length;q<z;q++){var h=r[q],x=d.attr(h),h=h.replace(/^data-/,"");if(h=validatorMap[h]){var h=h instanceof Array?h:["",h],B=d.closest(b.group);b.tips.target=B;var k=new Tips(b.tips),s=c[q]||("function"===typeof h[0]?h[0](d[0],d.val(),x):h[0]),h=h[1]||function(){return!0},f=d.is("input","select","textarea");if(h(d[0],d.val(),d.attr("type"),a.is("[data-validate], [pattern], [type=number], [type=email], [type=tel], [type=url], [type=date], [required], [minlength], [maxlength], [data-equalto], [data-oneoftwo]")?
b.parent||a.parents("form")[0]||a.parent()[0]:a[0],x))k.hide(),B.removeClass("has-error"),x=!0;else{s&&(k.error(s),B.addClass("has-error"));if(!1!==d[0].bindEvent){var u=f?"onchange":"onmouseout";d[0][u]=function(f){f=f||window.event;var c=$(this);/mouseout$/i.test(f.type)&&c.is(f.target||f.srcElement)||validation(c[0],$.extend(!0,{parent:a.is("[data-validate], [pattern], [type=number], [type=email], [type=tel], [type=url], [type=date], [required], [minlength], [maxlength], [data-equalto], [data-oneoftwo]")?
a.parents("form")[0]||a.parent()[0]:a[0]},b));this[u]=null}}x=!1;break}}else x=!0}x||e.push(d)});return e.length?(e.shift().focus(),!1):!0};$.fn.validation=function(a){return validation(this,a)};
(function(){var a=function(a,c){var d=$(a),e,l,t={},r=function(a,b){b=b||{};var c={},d;d="submit"===a.attr("type");var k=dataOptions(a,"ajax");if("string"===typeof k.config)try{c=JSON.parse(k.config)||{},delete k.config}catch(l){}else $.isPlainObject(k.config)&&(c=k.config,delete k.config);d&&(e=a.parents("form"));d=e&&e[0]?{url:e[0].action,data:e.serialize()+"&response_json=true",type:e[0].method||"post"}:{url:a.attr("href"),data:"response_json=true",type:a.data("ajaxMethod")||"post"};return c=$.extend(!0,
d,b,c,k)},q=function(a){d[0]&&d.removeClass(c.disabled);c.syncCache&&d[0]&&d.data("ajaxCache",c);t.json?w(a):location.href=c.url+(/\?/.test(c.url)?"&":"?")+c.data},w=function(a){function b(){"function"===typeof c.callback&&c.callback(a,d);e&&("back"==e?history.back():"reload"==e?location.reload():location.href=e)}if(a){if(c.progress)return c.progress.call(null,a);var e=a.redirect,t;c.showMessage&&!["error","success"].every(function(d){t=a.message;if(!t||!a[d])return!0;if(c.inject){if(d!==c.tipHidden){var e=
t,f=$(c.inject),u=c.position,p=c.ajaxTip;d+=c.tipCls;var y;f&&(y=f.getParent(),l=y.getElement("."+p),y&&l?l.html(e):$('<div class="'+d+" "+p+'">'+e+"</div>").appendTo(f,u))}}else Message[d](t,c.hideDelay,b);return!1})||b()}};if(d||d.length)c=r(d,c);return c=$.extend({disabled:"disabled",hideDelay:3,showMessage:!0,position:"before",tipCls:"-tip",ajaxTip:"ajax-tip",beforeSend:function(){if(d.length){var a;(a=d.hasClass(c.disabled))||(a={},a=e||a.data,a=a instanceof jQuery&&!validation(a)?!1:!0,(a=!a)||
...
a);b.box=b.options.select;$.ajax({type:"GET",url:b.options.dataUrl,dataType:"json",success:function(a){a?c(a):b.box.html("地区数据加载异常,请检查网络。")}})})()};$.fn.multiSelect=function(a){a=new AreaWidget($.extend({select:this},a||{}));return $(this).data("multiSelectInstance",a)};var priceControl={spec:{decimals:2,dec_point:".",thousands_sep:"",sign:"￥"},format:function(a,b){var c,d=this.spec.sign||"";if(!a&&0!==a||isNaN(+a))return a;a=parseFloat(a);this.spec.cur_rate&&(a*=this.spec.cur_rate);a=Math.round(a*Math.pow(10,this.spec.decimals))/Math.pow(10,this.spec.decimals)+"";var e=a.indexOf(".");0>e?(e=a.length,c=""):c=a.substr(e+1);for(;c.length<this.spec.decimals;)c+="0";for(var l=[];0<e;)if(2<e)e-=3,l.unshift(a.substr(e,3));else{l.unshift(a.substr(0,e));break}c||(this.spec.dec_point=
"");b&&(d='<span class="price-currency">'+d+"</span>");return d+l.join(this.spec.thousands_sep)+this.spec.dec_point+c},number:function(a){if(!a)return null;if(isNaN(+a)){if(a instanceof jQuery||a.nodeName&&1===a.nodeType)a=$(a).val()||$(a).text();0==a.indexOf(this.spec.sign)&&(a=a.split(this.spec.sign)[1])}return+a},calc:function(a,b,c,d){if(!b&&0!==b)return null;if(c){a=a&&"add"!=a?-1:1;var e=1,l=1;b instanceof Array&&b.length&&(e=b[1],b=b[0]);c instanceof Array&&c.length&&(l=c[1],c=c[0]);var t=
Math.pow(10,this.spec.decimals*this.spec.decimals);b=Math.abs(e*t*this.number(b)+a*l*t*this.number(c))/t}else b=this.number(b);d||(b=this.format(b));return b},add:function(a,b,c){return this.calc("add",a,b,c)},diff:function(a,b,c){return this.calc("diff",a,b,c)}};function updateCartNumber(a){a=$(a||".up-cat-number");var b=$(a).attr("data-type"),c;1==b?c=$.cookie("CARTNUMBER"):2==b&&(c=$.cookie("CARTVARIETY"));$(a).text(c)}
$(function(){$("body").on("click",".show-pics a",function(a){a.preventDefault();if(a=$(this).attr("href"))$.dialog($('<div><div class="show-pic-dialog"><div class="show-img"><img src="'+a+'"></div></div></div>'),{width:500,modal:!0,title:"查看大图"});else return!1})});(function(a,b){function c(){return new Date(Date.UTC.apply(Date,arguments))}function d(){var a=new Date;return c(a.getFullYear(),a.getMonth(),a.getDate())}function e(a){return function(){return this[a].apply(this,arguments)}}function l(f,b){function c(a,f){return f.toLowerCase()}var d=a(f).data(),g={},e,m=RegExp("^"+b.toLowerCase()+"([A-Z])");b=RegExp("^"+b.toLowerCase());for(var A in d)b.test(A)&&(e=A.replace(m,c),g[e]=d[A]);return g}function t(f){var b={};if(!k[f]&&(f=f.split("-")[0],!k[f]))return;
var c=k[f];a.each(B,function(a,f){f in c&&(b[f]=c[f])});return b}var r=a(window),q=function(){var f={get:function(a){return this.slice(a)[0]},contains:function(a){a=a&&a.valueOf();for(var f=0,b=this.length;f<b;f++)if(this[f].valueOf()===a)return f;return-1},remove:function(a){this.splice(a,1)},replace:function(f){f&&(a.isArray(f)||(f=[f]),this.clear(),this.push.apply(this,f))},clear:function(){this.length=0},copy:function(){var a=new q;a.replace(this);return a}};return function(){var b=[];b.push.apply(b,
arguments);a.extend(b,f);return b}}(),w=function(f,b){this.dates=new q;this.viewDate=d();this.focusDate=null;this._process_options(b);this.element=a(f);this.isInline=!1;this.isInput=this.element.is("input");this.hasInput=(this.component=this.element.is(".date")?this.element.find(".add-on, .input-comb-addon, .btn"):!1)&&this.element.find("input").length;this.component&&0===this.component.length&&(this.component=!1);this.picker=a(s.template);this._buildEvents();this._attachEvents();this.isInline?this.picker.addClass("datepicker-inline").appendTo(this.element):
this.picker.addClass("datepicker-dropdown dropdown-menu");this.o.rtl&&this.picker.addClass("datepicker-rtl");this.viewMode=this.o.startView;this.o.calendarWeeks&&this.picker.find("tfoot th.today").attr("colspan",function(a,f){return parseInt(f)+1});this._allow_update=!1;this.setStartDate(this._o.min);this.setEndDate(this._o.max);this.setDaysOfWeekDisabled(this.o.daysOfWeekDisabled);this.fillDow();this.fillMonths();this._allow_update=!0;this.update();this.showMode();this.isInline&&this.show()};w.prototype=
{constructor:w,_process_options:function(f){this._o=a.extend({},this._o,f);f=this.o=a.extend({},this._o);var b=f.language;k[b]||(b=b.split("-")[0],k[b]||(b=h.language));f.language=b;switch(f.startView){case 2:case "decade":f.startView=2;break;case 1:case "year":f.startView=1;break;default:f.startView=0}switch(f.minViewMode){case 1:case "months":f.minViewMode=1;break;case 2:case "years":f.minViewMode=2;break;default:f.minViewMode=0}f.startView=Math.max(f.startView,f.minViewMode);!0!==f.multidate&&
(f.multidate=Number(f.multidate)||!1,f.multidate=!1!==f.multidate?Math.max(0,f.multidate):1);f.multidateSeparator=String(f.multidateSeparator);f.weekStart%=7;f.weekEnd=(f.weekStart+6)%7;b=s.parseFormat(f.format);-Infinity!==f.min&&(f.min=f.min?f.min instanceof Date?this._local_to_utc(this._zero_time(f.min)):s.parseDate(f.min,b,f.language):-Infinity);Infinity!==f.max&&(f.max=f.max?f.max instanceof Date?this._local_to_utc(this._zero_time(f.max)):s.parseDate(f.max,b,f.language):Infinity);f.daysOfWeekDisabled=
...
this.picker.is(a.target)||this.picker.find(a.target).length||this.hide()},this)}]]},_attachEvents:function(){this._detachEvents();this._applyEvents(this._events)},_detachEvents:function(){this._unapplyEvents(this._events)},_attachSecondaryEvents:function(){this._detachSecondaryEvents();this._applyEvents(this._secondaryEvents)},_detachSecondaryEvents:function(){this._unapplyEvents(this._secondaryEvents)},_trigger:function(f,b){var c=b||this.dates.get(-1),c=this._utc_to_local(c);this.element.trigger({type:f,
date:c,dates:a.map(this.dates,this._utc_to_local),format:a.proxy(function(a,f){0===arguments.length?(a=this.dates.length-1,f=this.o.format):"string"===typeof a&&(f=a,a=this.dates.length-1);f=f||this.o.format;var b=this.dates.get(a);return s.formatDate(b,f,this.o.language)},this)})},show:function(){this.isInline||this.picker.appendTo("body");this.picker.show();this.place();this._attachSecondaryEvents();this._trigger("show")},hide:function(){!this.isInline&&this.picker.is(":visible")&&(this.focusDate=
...
setRange:function(b){b&&b.length?this.range=a.map(b,function(a){return a.valueOf()}):delete this.range;this.fill()},getClassNames:function(b){var c=[],d=this.viewDate.getUTCFullYear(),y=this.viewDate.getUTCMonth(),e=new Date;b.getUTCFullYear()<d||b.getUTCFullYear()===d&&b.getUTCMonth()<y?c.push("old"):(b.getUTCFullYear()>d||b.getUTCFullYear()===d&&b.getUTCMonth()>y)&&c.push("new");this.focusDate&&b.valueOf()===this.focusDate.valueOf()&&c.push("focused");this.o.todayHighlight&&b.getUTCFullYear()===
e.getFullYear()&&b.getUTCMonth()===e.getMonth()&&b.getUTCDate()===e.getDate()&&c.push("today");-1!==this.dates.contains(b)&&c.push("active");(b.valueOf()<this.o.min||b.valueOf()>this.o.max||-1!==a.inArray(b.getUTCDay(),this.o.daysOfWeekDisabled))&&c.push("disabled");this.range&&(b>this.range[0]&&b<this.range[this.range.length-1]&&c.push("range"),-1!==a.inArray(b.valueOf(),this.range)&&c.push("selected"));return c},fill:function(){var f=new Date(this.viewDate),d=f.getUTCFullYear(),p=d+k[this.o.language].year,
e=f.getUTCMonth(),f=-Infinity!==this.o.min?this.o.min.getUTCFullYear():-Infinity,g=-Infinity!==this.o.min?this.o.min.getUTCMonth():-Infinity,n=Infinity!==this.o.max?this.o.max.getUTCFullYear():Infinity,m=Infinity!==this.o.max?this.o.max.getUTCMonth():Infinity,l=k[this.o.language].today||"",h=k[this.o.language].clear||"",r;this.picker.find(".datepicker-days thead th.datepicker-switch").text(p+k[this.o.language].months[e]);this.picker.find("tfoot th.today").text(l).toggle(!1!==this.o.todayBtn);this.picker.find("tfoot th.clear").text(h).toggle(!1!==
this.o.clearBtn);this.updateNavArrows();this.fillMonths();e=c(d,e-1,28);p=s.getDaysInMonth(e.getUTCFullYear(),e.getUTCMonth());e.setUTCDate(p);e.setUTCDate(p-(e.getUTCDay()-this.o.weekStart+7)%7);l=new Date(e);l.setUTCDate(l.getUTCDate()+42);l=l.valueOf();for(p=[];e.valueOf()<l;){if(e.getUTCDay()===this.o.weekStart&&(p.push("<tr>"),this.o.calendarWeeks)){var h=new Date(+e+(this.o.weekStart-e.getUTCDay()-7)%7*864E5),h=new Date(Number(h)+(11-h.getUTCDay())%7*864E5),t=new Date(Number(t=c(h.getUTCFullYear(),
0,1))+(11-t.getUTCDay())%7*864E5);p.push('<td class="cw">'+((h-t)/864E5/7+1)+"</td>")}h=this.getClassNames(e);h.push("day");if(this.o.beforeShowDay!==a.noop){var q=this.o.beforeShowDay(this._utc_to_local(e));q===b?q={}:"boolean"===typeof q?q={enabled:q}:"string"===typeof q&&(q={classes:q});!1===q.enabled&&h.push("disabled");q.classes&&(h=h.concat(q.classes.split(/\s+/)));q.tooltip&&(r=q.tooltip)}h=a.unique(h);p.push('<td class="'+h.join(" ")+'"'+(r?' title="'+r+'"':"")+">"+e.getUTCDate()+"</td>");
e.getUTCDay()===this.o.weekEnd&&p.push("</tr>");e.setUTCDate(e.getUTCDate()+1)}this.picker.find(".datepicker-days tbody").empty().append(p.join(""));var C=this.picker.find(".datepicker-months").find("th:eq(1)").text(d).end().find("span").removeClass("active");a.each(this.dates,function(a,b){b.getUTCFullYear()===d&&C.eq(b.getUTCMonth()).addClass("active")});(d<f||d>n)&&C.addClass("disabled");d===f&&C.slice(0,g).addClass("disabled");d===n&&C.slice(m+1).addClass("disabled");p="";d=10*parseInt(d/10,10);
r=this.picker.find(".datepicker-years").find("th:eq(1)").text(d+"-"+(d+9)).end().find("td");d-=1;t=a.map(this.dates,function(a){return a.getUTCFullYear()});for(m=-1;11>m;m++)g=["year"],-1===m?g.push("old"):10===m&&g.push("new"),-1!==a.inArray(d,t)&&g.push("active"),(d<f||d>n)&&g.push("disabled"),p+='<span class="'+g.join(" ")+'">'+d+"</span>",d+=1;r.html(p)},updateNavArrows:function(){if(this._allow_update){var a=new Date(this.viewDate),b=a.getUTCFullYear(),a=a.getUTCMonth();switch(this.viewMode){case 0:-Infinity!==
...
Infinity!==this.o.max&&b>=this.o.max.getUTCFullYear()?this.picker.find(".next").css({visibility:"hidden"}):this.picker.find(".next").css({visibility:"visible"})}}},click:function(b){b.preventDefault();b=a(b.target).closest("span, td, th");var d,p,e;if(1===b.length)switch(b[0].nodeName.toLowerCase()){case "th":switch(b[0].className){case "datepicker-switch":this.showMode(1);break;case "prev":case "next":b=s.modes[this.viewMode].navStep*("prev"===b[0].className?-1:1);switch(this.viewMode){case 0:this.viewDate=
...
this.o.autoclose&&this.hide()}break;case "span":b.is(".disabled")||(this.viewDate.setUTCDate(1),b.is(".month")?(e=1,p=b.parent().find("span").index(b),d=this.viewDate.getUTCFullYear(),this.viewDate.setUTCMonth(p),this._trigger("changeMonth",this.viewDate),1===this.o.minViewMode&&this._setDate(c(d,p,e))):(e=1,p=0,d=parseInt(b.text(),10)||0,this.viewDate.setUTCFullYear(d),this._trigger("changeYear",this.viewDate),2===this.o.minViewMode&&this._setDate(c(d,p,e))),this.showMode(-1),this.fill());break;
case "td":b.is(".day")&&!b.is(".disabled")&&(e=parseInt(b.text(),10)||1,d=this.viewDate.getUTCFullYear(),p=this.viewDate.getUTCMonth(),b.is(".old")?0===p?(p=11,d-=1):p-=1:b.is(".new")&&(11===p?(p=0,d+=1):p+=1),this._setDate(c(d,p,e)))}this.picker.is(":visible")&&this._focused_from&&a(this._focused_from).focus();delete this._focused_from},_toggle_multidate:function(a){var b=this.dates.contains(a);a?-1!==b?this.dates.remove(b):this.dates.push(a):this.dates.clear();if("number"===typeof this.o.multidate)for(;this.dates.length>
this.o.multidate;)this.dates.remove(0)},_setDate:function(a,b){b&&"date"!==b||this._toggle_multidate(a&&new Date(a));b&&"view"!==b||(this.viewDate=a&&new Date(a));this.fill();this.setValue();this._trigger("changeDate");var c;this.isInput?c=this.element:this.component&&(c=this.element.find("input"));c&&c.change();!this.o.autoclose||b&&"date"!==b||this.hide()},moveMonth:function(a,c){if(!a)return b;if(!c)return a;var d=new Date(a.valueOf()),e=d.getUTCDate(),g=d.getUTCMonth(),n=Math.abs(c),m;c=0<c?1:
-1;if(1===n){if(n=-1===c?function(){return d.getUTCMonth()===g}:function(){return d.getUTCMonth()!==m},m=g+c,d.setUTCMonth(m),0>m||11<m)m=(m+12)%12}else{for(var l=0;l<n;l++)d=this.moveMonth(d,c);m=d.getUTCMonth();d.setUTCDate(e);n=function(){return m!==d.getUTCMonth()}}for(;n();)d.setUTCDate(--e),d.setUTCMonth(m);return d},moveYear:function(a,b){return this.moveMonth(a,12*b)},dateWithinRange:function(a){return a>=this.o.min&&a<=this.o.max},keydown:function(a){if(this.picker.is(":not(:visible)"))27===
a.keyCode&&this.show();else{var b=!1,c,e,g,n=this.focusDate||this.viewDate;switch(a.keyCode){case 27:this.focusDate?(this.focusDate=null,this.viewDate=this.dates.get(-1)||this.viewDate,this.fill()):this.hide();a.preventDefault();break;case 37:case 39:if(!this.o.keyboardNavigation)break;c=37===a.keyCode?-1:1;a.ctrlKey?(e=this.moveYear(this.dates.get(-1)||d(),c),g=this.moveYear(n,c),this._trigger("changeYear",this.viewDate)):a.shiftKey?(e=this.moveMonth(this.dates.get(-1)||d(),c),g=this.moveMonth(n,
c),this._trigger("changeMonth",this.viewDate)):(e=new Date(this.dates.get(-1)||d()),e.setUTCDate(e.getUTCDate()+c),g=new Date(n),g.setUTCDate(n.getUTCDate()+c));this.dateWithinRange(e)&&(this.focusDate=this.viewDate=g,this.setValue(),this.fill(),a.preventDefault());break;case 38:case 40:if(!this.o.keyboardNavigation)break;c=38===a.keyCode?-1:1;a.ctrlKey?(e=this.moveYear(this.dates.get(-1)||d(),c),g=this.moveYear(n,c),this._trigger("changeYear",this.viewDate)):a.shiftKey?(e=this.moveMonth(this.dates.get(-1)||
d(),c),g=this.moveMonth(n,c),this._trigger("changeMonth",this.viewDate)):(e=new Date(this.dates.get(-1)||d()),e.setUTCDate(e.getUTCDate()+7*c),g=new Date(n),g.setUTCDate(n.getUTCDate()+7*c));this.dateWithinRange(e)&&(this.focusDate=this.viewDate=g,this.setValue(),this.fill(),a.preventDefault());break;case 13:n=this.focusDate||this.dates.get(-1)||this.viewDate;this._toggle_multidate(n);b=!0;this.focusDate=null;this.viewDate=this.dates.get(-1)||this.viewDate;this.setValue();this.fill();this.picker.is(":visible")&&
...
"block");this.updateNavArrows()}};var z=function(b,c){this.element=a(b);this.inputs=a.map(c.inputs,function(a){return a.jquery?a[0]:a});delete c.inputs;a(this.inputs).datepicker(c).bind("changeDate",a.proxy(this.dateUpdated,this));this.pickers=a.map(this.inputs,function(b){return a(b).data("datepicker")});this.updateDates()};z.prototype={updateDates:function(){this.dates=a.map(this.pickers,function(a){return a.getUTCDate()});this.updateRanges()},updateRanges:function(){var b=a.map(this.dates,function(a){return a.valueOf()});
...
remove:function(){a.map(this.pickers,function(a){a.remove()});delete this.element.data().datepicker}};var x=a.fn.datepicker;a.fn.datepicker=function(c){var d=Array.apply(null,arguments);d.shift();var e;this.each(function(){var k=a(this),g=k.data("datepicker"),n;options="object"===typeof c&&c;k.is("[type=date]")?n=k:k.find("[type=date]").length&&(n=k.find("[type=date]"));n.length&&(n.attr("min")&&k.attr("data-date-min",n.attr("min")),n.attr("max")&&k.attr("data-date-max",n.attr("max")));g||(g=l(this,
"date"),n=a.extend({},h,g,options),n=t(n.language),g=a.extend({},h,n,g,options),k.is(".input-daterange")||g.inputs?(n={inputs:g.inputs||k.find("input").toArray()},k.data("datepicker",g=new z(this,a.extend(g,n)))):k.data("datepicker",g=new w(this,g)));if("string"===typeof c&&"function"===typeof g[c]&&(e=g[c].apply(g,d),e!==b))return!1});return e!==b?e:this};var h=a.fn.datepicker.defaults={autoclose:!0,beforeShowDay:a.noop,calendarWeeks:!1,clearBtn:!1,daysOfWeekDisabled:[],forceParse:!0,format:"yyyy-mm-dd",
keyboardNavigation:!0,language:"zh-CN",max:Infinity,min:-Infinity,minViewMode:0,multidate:!1,multidateSeparator:",",orientation:"auto",rtl:!1,startView:0,todayBtn:!1,todayHighlight:!0,weekStart:0},B=a.fn.datepicker.locale_opts=["format","rtl","weekStart"];a.fn.datepicker.Constructor=w;var k=a.fn.datepicker.dates={"zh-CN":{year:"年",months:"一月 二月 三月 四月 五月 六月 七月 八月 九月 十月 十一月 十二月".split(" "),monthsShort:"一月 二月 三月 四月 五月 六月 七月 八月 九月 十月 十一月 十二月".split(" "),days:"星期日 星期一 星期二 星期三 星期四 星期五 星期六 星期日".split(" "),
...
parseFormat:function(a){var b=a.replace(this.validParts,"\x00").split("\x00");a=a.match(this.validParts);if(!b||!b.length||!a||0===a.length)throw Error("Invalid date format.");return{separators:b,parts:a}},parseDate:function(d,e,p){function l(){var a=this.slice(0,n[h].length),b=n[h].slice(0,a.length);return a===b}if(!d)return b;if(d instanceof Date)return d;"string"===typeof e&&(e=s.parseFormat(e));var g=/([\-+]\d+)([dmwy])/,n=d.match(/([\-+]\d+)([dmwy])/g),m,h;if(/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(d)){d=
new Date;for(h=0;h<n.length;h++)switch(e=g.exec(n[h]),m=parseInt(e[1]),e[2]){case "d":d.setUTCDate(d.getUTCDate()+m);break;case "m":d=w.prototype.moveMonth.call(w.prototype,d,m);break;case "w":d.setUTCDate(d.getUTCDate()+7*m);break;case "y":d=w.prototype.moveYear.call(w.prototype,d,m)}return c(d.getUTCFullYear(),d.getUTCMonth(),d.getUTCDate(),0,0,0)}n=d&&d.match(this.nonpunctuation)||[];d=new Date;var g={},q="yyyy yy M MM m mm d dd".split(" ");m={yyyy:function(a,b){return a.setUTCFullYear(b)},yy:function(a,
b){return a.setUTCFullYear(2E3+b)},m:function(a,b){if(isNaN(a))return a;for(b-=1;0>b;)b+=12;b%=12;for(a.setUTCMonth(b);a.getUTCMonth()!==b;)a.setUTCDate(a.getUTCDate()-1);return a},d:function(a,b){return a.setUTCDate(b)}};var r;m.M=m.MM=m.mm=m.m;m.dd=m.d;d=c(d.getFullYear(),d.getMonth(),d.getDate(),0,0,0);var t=e.parts.slice();n.length!==t.length&&(t=a(t).filter(function(b,c){return-1!==a.inArray(c,q)}).toArray());if(n.length===t.length){var x;h=0;for(x=t.length;h<x;h++){r=parseInt(n[h],10);e=t[h];
if(isNaN(r))switch(e){case "MM":r=a(k[p].months).filter(l);r=a.inArray(r[0],k[p].months)+1;break;case "M":r=a(k[p].monthsShort).filter(l),r=a.inArray(r[0],k[p].monthsShort)+1}g[e]=r}for(h=0;h<q.length;h++)e=q[h],e in g&&!isNaN(g[e])&&(p=new Date(d),m[e](p,g[e]),isNaN(p)||(d=p))}return d},formatDate:function(b,c,d){if(!b)return"";"string"===typeof c&&(c=s.parseFormat(c));d={d:b.getUTCDate(),D:k[d].daysShort[b.getUTCDay()],DD:k[d].days[b.getUTCDay()],m:b.getUTCMonth()+1,M:k[d].monthsShort[b.getUTCMonth()],
MM:k[d].months[b.getUTCMonth()],yy:b.getUTCFullYear().toString().substring(2),yyyy:b.getUTCFullYear()};d.dd=(10>d.d?"0":"")+d.d;d.mm=(10>d.m?"0":"")+d.m;b=[];for(var e=a.extend([],c.separators),g=0,h=c.parts.length;g<=h;g++)e.length&&b.push(e.shift()),b.push(d[c.parts[g]]);return b.join("")},headTemplate:'<thead><tr><th class="prev">&laquo;</th><th colspan="5" class="datepicker-switch"></th><th class="next">&raquo;</th></tr></thead>',contTemplate:'<tbody><tr><td colspan="7"></td></tr></tbody>',footTemplate:'<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'};
