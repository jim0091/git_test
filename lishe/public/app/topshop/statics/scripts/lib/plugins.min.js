...
default:return this.options.message}},_getMessageContainer:function(a,f){var c=a.parent();if(c.is(f))return c;var e=c.attr("class");if(!e)return this._getMessageContainer(c,f);for(var e=e.split(" "),b=e.length,k=0;k<b;k++)if(/^col-(xs|sm|md|lg)-\d+$/.test(e[k])||/^col-(xs|sm|md|lg)-offset-\d+$/.test(e[k]))return c;return this._getMessageContainer(c,f)},_submit:function(){var d=this.isValid(),f=a.Event(d?this.options.events.formSuccess:this.options.events.formError);this.$form.trigger(f);this.$submitButton&&
(d?this._onSuccess(f):this._onError(f))},_isExcluded:function(d){var f=d.attr("data-validate-excluded"),c=d.attr("data-validate-field")||d.attr("name");switch(!0){case !!c&&this.options.fields&&this.options.fields[c]&&("true"===this.options.fields[c].excluded||!0===this.options.fields[c].excluded):case "true"===f:case ""===f:return!0;case !!c&&this.options.fields&&this.options.fields[c]&&("false"===this.options.fields[c].excluded||!1===this.options.fields[c].excluded):case "false"===f:return!1;default:if(this.options.excluded)for("string"===
typeof this.options.excluded&&(this.options.excluded=a.map(this.options.excluded.split(","),function(d){return a.trim(d)})),f=this.options.excluded.length,c=0;c<f;c++)if("string"===typeof this.options.excluded[c]&&d.is(this.options.excluded[c])||"function"===typeof this.options.excluded[c]&&!0===this.options.excluded[c].call(this,d,this))return!0;return!1}},_exceedThreshold:function(d){var f=d.attr("data-validate-field");return(f=this.options.fields[f].threshold||this.options.threshold)?-1!==a.inArray(d.attr("type"),
"button checkbox file hidden image radio reset submit".split(" "))||d.val().length>=f:!0},_onError:function(d){if(!d.isDefaultPrevented()){if("submitted"===this.options.live){this.options.live="enabled";var f=this,c;for(c in this.options.fields)(function(b){b=f.getFieldElements(b);if(b.length){var d=a(b[0]).attr("type"),d="radio"===d||"checkbox"===d||"file"===d||"SELECT"===a(b[0]).get(0).tagName?"change":f._changeEvent,d=a.map((f.options.fields[c].trigger||f.options.trigger||d).split(" "),function(b){return b+
".live.validate"}).join(" ");b.off(d).on(d,function(){f._exceedThreshold(a(this))&&f.validateField(a(this))})}})(c)}for(var e=0;e<this.$invalidFields.length;e++)if(d=this.$invalidFields.eq(e),this._isOptionEnabled(d.attr("data-validate-field"),"autoFocus")){var e=d.parents(".tab-pane"),b;e&&(b=e.attr("id"))&&a('a[href="#'+b+'"][data-toggle="tab"]').tab("show");d.focus();break}}},_onSuccess:function(a){a.isDefaultPrevented()||this.defaultSubmit()},_onFieldValidated:function(d,f){var c=d.attr("data-validate-field"),
e=this.options.fields[c].validators,b={},k=0,h={validate:this,field:c,element:d,validator:f,result:d.data("validate.response."+f)};if(f)switch(d.data("validate.result."+f)){case this.STATUS_INVALID:d.trigger(a.Event(this.options.events.validatorError),h);break;case this.STATUS_VALID:d.trigger(a.Event(this.options.events.validatorSuccess),h)}b[this.STATUS_NOT_VALIDATED]=0;b[this.STATUS_VALIDATING]=0;b[this.STATUS_INVALID]=0;b[this.STATUS_VALID]=0;for(var g in e)if(!1!==e[g].enabled){k++;var l=d.data("validate.result."+
g);l&&b[l]++}b[this.STATUS_VALID]===k?(this.$invalidFields=this.$invalidFields.not(d),d.trigger(a.Event(this.options.events.fieldSuccess),h)):(0===b[this.STATUS_NOT_VALIDATED]||!this._isOptionEnabled(c,"verbose"))&&0===b[this.STATUS_VALIDATING]&&0<b[this.STATUS_INVALID]&&(this.$invalidFields=this.$invalidFields.add(d),d.trigger(a.Event(this.options.events.fieldError),h))},_isOptionEnabled:function(a,f){return!this.options.fields[a]||"true"!==this.options.fields[a][f]&&!0!==this.options.fields[a][f]?
!this.options.fields[a]||"false"!==this.options.fields[a][f]&&!1!==this.options.fields[a][f]?"true"===this.options[f]||!0===this.options[f]:!1:!0},getFieldElements:function(d){this._cacheFields[d]||(this._cacheFields[d]=this.options.fields[d]&&this.options.fields[d].selector?a(this.options.fields[d].selector):this.$form.find('[name="'+d+'"]'));return this._cacheFields[d]},getOptions:function(a,f,c){if(!a)return c?this.options[c]:this.options;"object"===typeof a&&(a=a.attr("data-validate-field"));
if(!this.options.fields[a])return null;a=this.options.fields[a];return f?a.validators&&a.validators[f]?c?a.validators[f][c]:a.validators[f]:null:c?a[c]:a},disableSubmitButtons:function(a){a?"disabled"!==this.options.live&&this.$form.find(this.options.submitButtons).attr("disabled","disabled"):this.$form.find(this.options.submitButtons).removeAttr("disabled");return this},validate:function(){if(!this.options.fields)return this;this._submitIfValid=!1;for(var a in this.options.fields)this.validateField(a);
this._submit();this._submitIfValid=!0;return this},validateField:function(d){var f=a([]);switch(typeof d){case "object":f=d;d=d.attr("data-validate-field");break;case "string":f=this.getFieldElements(d)}if(0===f.length||!this.options.fields[d]||!1===this.options.fields[d].enabled)return this;for(var c=this,e=f.attr("type"),b="radio"===e||"checkbox"===e?1:f.length,k="radio"===e||"checkbox"===e,e=this.options.fields[d].validators,h=this._isOptionEnabled(d,"verbose"),g,l,m=0;m<b;m++){var u=f.eq(m);if(!this._isExcluded(u)){var n=
!1;for(g in e){u.data("validate.dfs."+g)&&u.data("validate.dfs."+g).reject();if(n)break;l=u.data("validate.result."+g);if(l===this.STATUS_VALID||l===this.STATUS_INVALID)this._onFieldValidated(u,g);else if(!1===e[g].enabled)this.updateStatus(k?d:u,this.STATUS_VALID,g);else if(u.data("validate.result."+g,this.STATUS_VALIDATING),l=a.fn.Validator.validators[g].validate(this,u,e[g]),"object"===typeof l&&l.resolve)this.updateStatus(k?d:u,this.STATUS_VALIDATING,g),u.data("validate.dfs."+g,l),l.done(function(a,
b,d){a.removeData("validate.dfs."+b).data("validate.response."+b,d);d.message&&c.updateMessage(a,b,d.message);c.updateStatus(k?a.attr("data-validate-field"):a,d.valid?c.STATUS_VALID:c.STATUS_INVALID,b);d.valid&&!0===c._submitIfValid?c._submit():d.valid||h||(n=!0)});else if("object"===typeof l&&void 0!==l.valid&&void 0!==l.message){if(u.data("validate.response."+g,l),this.updateMessage(k?d:u,g,l.message),this.updateStatus(k?d:u,l.valid?this.STATUS_VALID:this.STATUS_INVALID,g),!l.valid&&!h)break}else if("boolean"===
typeof l&&(u.data("validate.response."+g,l),this.updateStatus(k?d:u,l?this.STATUS_VALID:this.STATUS_INVALID,g),!l&&!h))break}}}return this},updateMessage:function(d,f,c){var e=a([]);switch(typeof d){case "object":e=d;d=d.attr("data-validate-field");break;case "string":e=this.getFieldElements(d)}e.each(function(){a(this).data("validate.messages").find('.help-block[data-validate-validator="'+f+'"][data-validate-for="'+d+'"]').html(c)})},updateStatus:function(d,f,c){var e=a([]);switch(typeof d){case "object":e=
d;d=d.attr("data-validate-field");break;case "string":e=this.getFieldElements(d)}f===this.STATUS_NOT_VALIDATED&&(this._submitIfValid=!1);for(var b=e.attr("type"),k=this.options.fields[d].group||this.options.group,b="radio"===b||"checkbox"===b?1:e.length,h=0;h<b;h++){var g=e.eq(h);if(!this._isExcluded(g)){var l=g.parents(k),m=g.data("validate.messages").find('[class|=help][data-validate-validator][data-validate-for="'+d+'"]'),u=c?m.filter('[data-validate-validator="'+c+'"]'):m,n=g.data("validate.icon"),
v="function"===typeof(this.options.fields[d].container||this.options.container)?(this.options.fields[d].container||this.options.container).call(this,g,this):this.options.fields[d].container||this.options.container,C=null;if(c)g.data("validate.result."+c,f);else for(var s in this.options.fields[d].validators)g.data("validate.result."+s,f);u.attr("data-validate-result",f);var H=g.parents(".tab-pane"),Q,Z;H&&(Q=H.attr("id"))&&(Z=a('a[href="#'+Q+'"][data-toggle="tab"]').parent());switch(f){case this.STATUS_VALIDATING:C=
null;l.removeClass("has-success").removeClass("has-error");n&&n.removeClass(this.options.icons.valid).removeClass(this.options.icons.invalid).addClass(this.options.icons.validating).css("display","");Z&&Z.removeClass("validate-tab-success").removeClass("validate-tab-error");break;case this.STATUS_INVALID:C=!1;l.removeClass("has-success").addClass("has-error");n&&n.removeClass(this.options.icons.valid).removeClass(this.options.icons.validating).addClass(this.options.icons.invalid).css("display","");
