...
"left"),d.parent().css("width",b.viewSize[0]*b.viewLength+"px"));break;case "fade":d.each(function(b){a(this).css({opacity:b>=m&&b<=p?1:0,position:"absolute",zIndex:b>=m&&b<=p?9:1})})}else console.log(d.selector),d.eq(k).siblings(d.selector()+":visible").css("display","none")}});a.extend(SP,{_switchView:function(b,h,e){var d=this.config.effect;(a.isFunction(d)?d:c[d]).call(this,b,h,function(){},e)}});a.extend(a.fn.switchable.defaults,{lazyload:!1,lazyDataType:"data-src"});b.Plugins.push({name:"lazyload",
_init:function(b){function c(m,p){var l=d.step,q=p*l;a.loadCustomLazyData(g.slice(q,q+l),k);e()&&(b.afterSwitch(),m=a.Event("afterSwitch.switchable"),b.$container.trigger(m).off("beforeSwitch.switchable",c))}function e(){var a,c=!0;"data-src"===k&&(a="IMG"==g[0].nodeName?b.$panels:b.$panels.find("img"),a.each(function(){if(this.getAttribute(k))return c=!1}));return c}var d=b.config;if(d.lazyload){var g=a.makeArray(b.$panels),k=d.lazyDataType;b.beforeSwitch(c);b.$container.trigger("beforeSwitch.switchable")}}});
a.extend({loadCustomLazyData:function(b,c,e){var d,g;a.each(b,function(){switch(c){case "action-lazyload":g="TEXTAREA"===this.nodeName&&a(this).hasClass("action-lazyload")?a(this):a(this).find("textarea.action-lazyload");var b=a("<div/>").insertAfter(g);g&&g.val()&&(evalScripts(g.val(),b,e),g.remove());break;default:(d="IMG"===this.nodeName&&a(this).attr("data-src")?a(this):a(this).find("img[data-src]"))&&d.each(function(){var a=this.getAttribute(c);a&&this.src!=a&&(this.src=a,this.removeAttribute(c))})}})}});
b.autoRender=function(b,c){var e=this;b=b||"[data-toggle=switchable]";var d=a(c||document.body).find(b);a.loadCustomLazyData(a(c||document.body),"action-lazyload");d.each(function(){try{var b=a(this).data("switchableConfig"),c=dataOptions(this,"switchable");"string"===typeof b&&(b=JSON.parse(b));a(this).removeData("switchableConfig");a.extend(!0,b,c||{});new e(a(this),b)}catch(d){}})}})(jQuery);jQuery(function(a){a.Switchable.autoRender()});var Dialog=new Class({options:{title:"提示",minHeight:50,minWidth:80,locate:{target:document.body,x:"center",y:"center",pos:"absolute"},frameTpl:'<iframe allowtransparency="allowtransparency" align="middle" frameborder="0" height="100%" width="100%" scrolling="auto" src="about:blank">请使用支持iframe框架的浏览器。</iframe>',ajaxTpl:'<div class="loading">loading...</div>',asyncOptions:{type:"get"},component:{container:"dialog",body:"dialog-body",header:"dialog-header",close:"dialog-btn-close",content:"dialog-content"}},
...
function Message(a,b,c,f){if(!a)return null;isNaN(b)?"function"===$.type(c)?(f=c,c=3):(b=b||"show",c=isNaN(c)?3:c):(c=b,b="show");var h={container:"message-"+b,body:"message-body",content:"message-content",icon:{show:"",success:"&#x25;",error:"&#x21;"}[b]},e=$("#pop_message_"+b);e&&(e=e.data("instance"))&&e.content.html(a).show();new Dialog($("<div>"+a+"</div>"),{id:"pop_message_"+b,type:"nohead",template:$("#message_template"),modal:!1,single:!0,autoHide:c,component:h,show:function(){this.stopTimer()},
...
$(function(){$(".images-uploader").AjaxFileUpload({onComplete:function(a,b){if(a.error)return alert(a.message);var c=$.makeArray(a.data),f=b.find("input[type=file]").attr("name");$.each(c,function(){b.find(".action-upload").before('<div class="handle img-thumbnail"><i class="icon-close-b action-remove"></i><a href="'+this.url+'" target="_blank"><img src="'+this.url+'"></a><input type="hidden" name="'+f+'" value="'+this.url+'"></div>')});b.on("click",".action-remove",function(a){$(this).parent().remove()});
