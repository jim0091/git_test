...
function(e, t) {
    ...
    function h(e, t) {
        for (var n = e.length,
        r = 0; n > r; r++) me.set(e[r], "globalEval", !t || me.get(t[r], "globalEval"))
    }
    function g(e, t) {
        var n, r, i, o, s, a, u, c;
        if (1 === t.nodeType) {
            if (me.hasData(e) && (o = me.access(e), s = me.set(t, o), c = o.events)) {
                delete s.handle,
                s.events = {};
                for (i in c) for (n = 0, r = c[i].length; r > n; n++) oe.event.add(t, i, c[i][n])
            }
            ge.hasData(e) && (a = ge.access(e), u = oe.extend({},
            a), ge.set(t, u))
        }
    }
    function m(e, n) {
    ...
    function v(e, t) {
        if (t in e) return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Ke.length; i--;) if (t = Ke[i] + n, t in e) return t;
        return r
    }
    function x(e, t) {
        return e = t || e,
    ...
    function w(e, t) {
        ...
        r.style && (o[s] = me.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && x(r) && (o[s] = me.access(r, "olddisplay", N(r.nodeName)))) : o[s] || (i = x(r), (n && "none" !== n || !i) && me.set(r, "olddisplay", i ? n: oe.css(r, "display"))));
        for (s = 0; a > s; s++) r = e[s],
    ...
    function C(e, t, n, r, i) {
        for (var o = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)"margin" === n && (s += oe.css(e, n + Je[o], !0, i)),
        r ? ("content" === n && (s -= oe.css(e, "padding" + Je[o], !0, i)), "margin" !== n && (s -= oe.css(e, "border" + Je[o] + "Width", !0, i))) : (s += oe.css(e, "padding" + Je[o], !0, i), "padding" !== n && (s += oe.css(e, "border" + Je[o] + "Width", !0, i)));
        return s
    }
    function k(e, t, n) {
        var r = !0,
    ...
    function N(e) {
        var t = X,
        n = Ve[e];
        return n || (n = j(e, t), "none" !== n && n || (_e = (_e || oe("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (_e[0].contentWindow || _e[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = j(e, t), _e.detach()), Ve[e] = n),
        n
    }
    function j(e, t) {
    ...
    function F(e, t, n) {
        ...
        u = function() {
            if (i) return ! 1;
            for (var t = Et || H(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, s = 0, u = c.tweens.length; u > s; s++) c.tweens[s].run(o);
        ...
        l = c.props;
        for (P(l, c.opts.specialEasing); s > o; o++) if (r = Lt[o].call(c, e, l, c.opts)) return r;
        return oe.map(l, O, c),
    ...
    function R(e, n, r) {
        ...
        d = e.nodeType && x(e),
        h = me.get(e, "fxshow");
        r.queue || (u = oe._queueHooks(e, "fx"), null == u.unqueued && (u.unqueued = 0, c = u.empty.fire, u.empty.fire = function() {
            u.unqueued || c()
        ...
        1 === e.nodeType && ("height" in n || "width" in n) && (r.overflow = [p.overflow, p.overflowX, p.overflowY], "inline" === oe.css(e, "display") && "none" === oe.css(e, "float") && (p.display = "inline-block")),
        ...
        if (!oe.isEmptyObject(f)) {
            h ? "hidden" in h && (d = h.hidden) : h = me.access(e, "fxshow", {}),
            s && (h.hidden = !d),
            d ? oe(e).show() : l.done(function() {
                oe(e).hide()
            }),
            l.done(function() {
                var t;
            ...
            for (i in f) a = O(d ? h[i] : 0, i, l),
            i in h || (h[i] = a.start, d && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    oe.fn = oe.prototype = {
        ...
        init: function(e, n, r) {
            ...
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    if (n = n instanceof oe ? n[0] : n, oe.merge(this, oe.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n: X, !0)), ce.test(i[1]) && oe.isPlainObject(n)) for (i in n) oe.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
                    return this
                }
    ...
    oe.extend = oe.fn.extend = function() {
        ...
        c = arguments.length,
        l = !1;
        for ("boolean" == typeof a && (l = a, a = arguments[1] || {},
        u = 2), "object" == typeof a || oe.isFunction(a) || (a = {}), c === u && (a = this, --u); c > u; u++) if (null != (e = arguments[u])) for (n in e) r = a[n],
        i = e[n],
        a !== i && (l && i && (oe.isPlainObject(i) || (o = oe.isArray(i))) ? (o ? (o = !1, s = r && oe.isArray(r) ? r: []) : s = r && oe.isPlainObject(r) ? r: {},
        a[n] = oe.extend(l, s, i)) : i !== t && (a[n] = i));
        return a
    },
    oe.extend({
        ...
        ready: function(e) { (e === !0 ? --oe.readyWait: oe.isReady) || (oe.isReady = !0, e !== !0 && --oe.readyWait > 0 || (I.resolveWith(X, [oe]), oe.fn.trigger && oe(X).trigger("ready").off("ready")))
        },
        ...
        globalEval: function(e) {
            var t, n = eval;
            e = oe.trim(e),
            e && (1 === e.indexOf("use strict") ? (t = X.createElement("script"), t.text = e, X.head.appendChild(t).parentNode.removeChild(t)) : n(e))
        },
        ...
        proxy: function(e, n) {
            ...
            oe.isFunction(e) ? (i = ee.call(arguments, 2), o = function() {
        ...
        access: function(e, n, r, i, o, s, a) {
            ...
            })), n)) for (; c > u; u++) n(e[u], r, a ? i: i.call(e[u], u, n(e[u], r)));
    ...
    oe.ready.promise = function(t) {
        return I || (I = oe.Deferred(), "complete" === X.readyState ? setTimeout(oe.ready) : (X.addEventListener("DOMContentLoaded", de, !1), e.addEventListener("load", de, !1))),
        I.promise(t)
    },
    ...
    function(e, t) {
        function n(e, t, n, r) {
            ...
            if (O && !r) {
                if (i = xe.exec(e)) if (s = i[1]) {
                    ...
                    n;
                    if ((s = i[3]) && C.getElementsByClassName && t.getElementsByClassName) return ee.apply(n, t.getElementsByClassName(s)),
                    n
                }
                if (C.qsa && (!F || !F.test(e))) {
                    if (f = l = W, h = t, g = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
        ...
        function p(e, t) {
            ...
            for (a = e, u = [], c = N.preFilter; a;) { (!r || (i = fe.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [])),
                r = !1,
                (i = pe.exec(a)) && (r = i.shift(), o.push({
                    value: r,
                    type: i[0].replace(le, " ")
                }), a = a.slice(r.length));
                for (s in N.filter) ! (i = ye[s].exec(a)) || c[s] && !(i = c[s](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: s,
                    matches: i
                }), a = a.slice(r.length));
        ...
        function h(e, t, n) {
            ...
            function(t, n, o) {
                ...
                } else for (; t = t[r];) if (1 === t.nodeType || i) if (c = t[W] || (t[W] = {}), (u = c[r]) && u[0] === l) {
                    if ((a = u[1]) === !0 || a === k) return a === !0
                } else if (u = c[r] = [l], u[1] = e(t, n, s) || k, u[1] === !0) return ! 0
            }
        }
        function g(e) {
            return e.length > 1 ?
        ...
        function y(e, t, n, r, o, s) {
            ...
            i(function(i, s, a, u) {
                ...
                v = n ? o || (i ? e: h || r) ? [] : s: y;
                if (n && n(y, v, a, u), r) for (c = m(v, d), r(c, [], a, u), l = c.length; l--;)(f = c[l]) && (v[d[l]] = !(y[d[l]] = f));
                if (i) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (l = v.length; l--;)(f = v[l]) && (c = o ? ne.call(i, f) : p[l]) > -1 && (i[c] = !(s[c] = f))
                    }
                } else v = m(v === s ? v.splice(h, v.length) : v),
                o ? o(null, s, v, u) : ee.apply(s, v)
            })
        }
        function v(e) {
            for (var t, n, r, i = e.length,
            o = N.relative[e[0].type], s = o || N.relative[" "], a = o ? 1 : 0, u = h(function(e) {
                return e === t
            },
            s, !0), c = h(function(e) {
            ...
            }]; i > a; a++) if (n = N.relative[e[a].type]) l = [h(g(l), n)];
            else {
                if (n = N.filter[e[a].type].apply(null, e[a].matches), n[W]) {
                    for (r = ++a; i > r && !N.relative[e[r].type]; r++);
                    return y(a > 1 && g(l), a > 1 && d(e.slice(0, a - 1).concat({
                        value: " " === e[a - 2].type ? "*": ""
                    })).replace(le, "$1"), n, r > a && v(e.slice(a, r)), i > r && v(e = e.slice(r)), i > r && d(e))
                }
                l.push(n)
            }
            return g(l)
        ...
        function x(e, t) {
            ...
            a = function(i, a, u, c, l) {
                ...
                x = null != l,
                b = D,
                w = i || s && N.find.TAG("*", l && a.parentNode || a),
                ...
                if (g += y, o && y !== g) {
                    ...
                    if (i) {
                        if (g > 0) for (; y--;) v[y] || h[y] || (h[y] = J.call(c));
                        h = m(h)
                    }
                    ee.apply(c, h),
                    x && !i && h.length > 0 && g + t.length > 1 && n.uniqueSort(c)
                }
                return x && (B = T, D = b),
                v
            };
        ...
        function w(e, t, n, r) {
            var i, o, s, a, u, c = p(e);
            if (!r && 1 === c.length) {
                if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && C.getById && 9 === t.nodeType && O && N.relative[o[1].type]) {
                ...
                for (i = ye.needsContext.test(e) ? 0 : o.length; i--&&(s = o[i], !N.relative[a = s.type]);) if ((u = N.find[a]) && (r = u(s.matches[0].replace(Ce, ke), de.test(o[0].type) && t.parentNode || t))) {
                    if (o.splice(i, 1), e = r.length && d(o), !e) return ee.apply(n, r),
                    n;
                    break
                }
            }
            return S(e, c)(r, t, !O, n, de.test(e)),
            n
        }
        var T, C, k, N, j, E, S, D, A, q, L, H, O, F, P, R, M, W = "sizzle" + -new Date,
        $ = e.document,
        B = 0,
        I = 0,
        _ = r(),
        ...
        try {
            ee.apply(Z = te.call($.childNodes), $.childNodes),
        ...
        C = n.support = {},
        q = n.setDocument = function(e) {
            var t = e ? e.ownerDocument || e: $,
            n = t.defaultView;
            return t !== L && 9 === t.nodeType && t.documentElement ? (L = t, H = t.documentElement, O = !E(t), n && n.attachEvent && n !== n.top && n.attachEvent("onbeforeunload",
            function() {
                q()
                ...
                !t.getElementsByName || !t.getElementsByName(W).length
            ...
            P = [], F = [], (C.qsa = ve.test(t.querySelectorAll)) && (o(function(e) {
                ...
                e.querySelectorAll("[selected]").length || F.push("\\[" + ie + "*(?:value|" + re + ")"),
                e.querySelectorAll(":checked").length || F.push(":checked")
            }), o(function(e) {
                var n = t.createElement("input");
                n.setAttribute("type", "hidden"),
                e.appendChild(n).setAttribute("t", ""),
                e.querySelectorAll("[t^='']").length && F.push("[*^$]=" + ie + "*(?:''|\"\")"),
                ...
                C.disconnectedMatch = R.call(e, "div"),
                R.call(e, "[s!='']:x"),
                P.push("!=", ce)
            }), F = F.length && new RegExp(F.join("|")), P = P.length && new RegExp(P.join("|")), M = ve.test(H.contains) || H.compareDocumentPosition ?
            function(e, t) {
        ...
        n.attr = function(e, n) { (e.ownerDocument || e) !== L && q(e);
        ...
        N = n.selectors = {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(Ce, ke),
                    e[3] = (e[4] || e[5] || "").replace(Ce, ke),
                    "~=" === e[2] && (e[3] = " " + e[3] + " "),
                    e.slice(0, 4)
                },
                CHILD: function(e) {
            ...
            filter: {
                ...
                CLASS: function(e) {
                    var t = _[e + " "];
                    return t || (t = new RegExp("(^|" + ie + ")" + e + "(" + ie + "|$)")) && _(e,
                    function(e) {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    function(e) {
                        ...
                        if (m) {
                            ...
                            } else if (v && (c = (t[W] || (t[W] = {}))[e]) && c[0] === B) p = c[1];
                            else for (; (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== y: 1 !== f.nodeType) || !++p || (v && ((f[W] || (f[W] = {}))[e] = [B, p]), f !== t)););
                            return p -= i,
                            p === r || p % r === 0 && p / r >= 0
                        }
                    }
                ...
                PSEUDO: function(e, t) {
                    ...
                    return o[W] ? o(t) : o.length > 1 ? (r = [e, e, "", t], N.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, n) {
                        for (var r, i = o(e, t), s = i.length; s--;) r = ne.call(e, i[s]),
                        e[r] = !(n[r] = i[s])
                    }) : function(e) {
                        return o(e, 0, r)
                    }) : o
        ...
        C.sortStable = W.split("").sort(Y).join("") === W,
    ...
    oe.Callbacks = function(e) {
        e = "string" == typeof e ? he[e] || r(e) : oe.extend({},
        e);
        var n, i, o, s, a, u, c = [],
        l = !e.once && [],
        f = function(t) {
            for (n = e.memory && t, i = !0, u = s || 0, s = 0, a = c.length, o = !0; c && a > u; u++) if (c[u].apply(t[0], t[1]) === !1 && e.stopOnFalse) {
                n = !1;
                break
            }
            o = !1,
            c && (l ? l.length && f(l.shift()) : n ? c = [] : p.disable())
        },
        p = {
            add: function() {
                if (c) {
                    ...
                    o ? a = c.length: n && (s = t, f(n))
                }
                return this
            },
            remove: function() {
                return c && oe.each(arguments,
                function(e, t) {
                    for (var n; (n = oe.inArray(t, c, n)) > -1;) c.splice(n, 1),
                    o && (a >= n && a--, u >= n && u--)
                }),
                this
            },
            ...
            fireWith: function(e, t) {
                return ! c || i && !l || (t = t || [], t = [e, t.slice ? t.slice() : t], o ? l.push(t) : f(t)),
                this
            },
            fire: function() {
    ...
    oe.extend({
        ...
        when: function(e) {
            ...
            if (s > 1) for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) o[i] && oe.isFunction(o[i].promise) ? o[i].promise().done(c(i, r, o)).fail(u.reject).progress(c(i, n, t)) : --a;
    ...
    i.prototype = {
        ...
        remove: function(e, n) {
            ...
            if (n === t) this.cache[s] = {};
                ...
                oe.isArray(n) ? i = n.concat(n.map(oe.camelCase)) : (o = oe.camelCase(n), n in a ? i = [n, o] : (i = o, i = i in a ? [i] : i.match(ae) || [])),
                r = i.length;
                for (; r--;) delete a[i[r]]
            }
        },
        ...
        data: function(e, n) {
            ...
            if (e === t) {
                if (this.length && (u = ge.get(s), 1 === s.nodeType && !me.get(s, "hasDataAttrs"))) {
                    ...
                    0 === i.indexOf("data-") && (i = oe.camelCase(i.slice(5)), o(s, i, u[i]));
    ...
    oe.fn.extend({
        queue: function(e, n) {
            ...
            arguments.length < r ? oe.queue(this[0], e) : n === t ? this: this.each(function() {
        ...
        promise: function(e, n) {
            ...
            for ("string" != typeof e && (n = e, e = t), e = e || "fx"; a--;) r = me.get(s[a], e + "queueHooks"),
    ...
    oe.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(n) {
                ...
                i = oe(this), o = e.match(ae) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else(n === _ || "boolean" === n) && (this.className && me.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "": me.get(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ",
            n = 0,
            r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(we, " ").indexOf(t) >= 0) return ! 0;
            return ! 1
        },
        val: function(e) {
            var n, r, i, o = this[0]; {
                ...
                this.each(function(r) {
                    var o;
                    1 === this.nodeType && (o = i ? e.call(this, r, oe(this).val()) : e, null == o ? o = "": "number" == typeof o ? o += "": oe.isArray(o) && (o = oe.map(o,
                    function(e) {
                        return null == e ? "": e + ""
                    })), n = oe.valHooks[this.type] || oe.valHooks[this.nodeName.toLowerCase()], n && "set" in n && n.set(this, o, "value") !== t || (this.value = o))
                });
                if (o) return n = oe.valHooks[o.type] || oe.valHooks[o.nodeName.toLowerCase()],
                n && "get" in n && (r = n.get(o, "value")) !== t ? r: (r = o.value, "string" == typeof r ? r.replace(Te, "") : null == r ? "": r)
            }
        }
    }),
    oe.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    ...
                    s = o ? null: [], a = o ? i + 1 : r.length, u = 0 > i ? a: o ? i: 0; a > u; u++) if (n = r[u], (n.selected || u === i) && (oe.support.optDisabled ? !n.disabled: null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !oe.nodeName(n.parentNode, "optgroup"))) {
        ...
        attr: function(e, n, r) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s) return typeof e.getAttribute === _ ? oe.prop(e, n, r) : (1 === s && oe.isXMLDoc(e) || (n = n.toLowerCase(), i = oe.attrHooks[n] || (oe.expr.match.bool.test(n) ? be: xe)), r === t ? i && "get" in i && null !== (o = i.get(e, n)) ? o: (o = oe.find.attr(e, n), null == o ? t: o) : null !== r ? i && "set" in i && (o = i.set(e, r, n)) !== t ? o: (e.setAttribute(n, r + ""), r) : void oe.removeAttr(e, n))
        },
        ...
        prop: function(e, n, r) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a) return s = 1 !== a || !oe.isXMLDoc(e),
    ...
    oe.event = {
        ...
        add: function(e, n, r, i, o) {
            ...
            if (y) {
                for (r.handler && (s = r, r = s.handler, o = s.selector), r.guid || (r.guid = oe.guid++), (c = y.events) || (c = y.events = {}), (a = y.handle) || (a = y.handle = function(e) {
                    return typeof oe === _ || e && oe.event.triggered === e.type ? t: oe.event.dispatch.apply(a.elem, arguments)
                },
                a.elem = e), n = (n || "").match(ae) || [""], l = n.length; l--;) u = Ee.exec(n[l]) || [],
                h = m = u[1],
                g = (u[2] || "").split(".").sort(),
                h && (p = oe.event.special[h] || {},
                h = (o ? p.delegateType: p.bindType) || h, p = oe.event.special[h] || {},
                f = oe.extend({
                    type: h,
                    origType: m,
                    data: i,
                ...
                s), (d = c[h]) || (d = c[h] = [], d.delegateCount = 0, p.setup && p.setup.call(e, i, g, a) !== !1 || e.addEventListener && e.addEventListener(h, a, !1)), p.add && (p.add.call(e, f), f.handler.guid || (f.handler.guid = r.guid)), o ? d.splice(d.delegateCount++, 0, f) : d.push(f), oe.event.global[h] = !0);
                e = null
            }
        },
        remove: function(e, t, n, r, i) {
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(ae) || [""], c = t.length; c--;) if (a = Ee.exec(t[c]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                    for (f = oe.event.special[d] || {},
                    d = (r ? f.delegateType: f.bindType) || d, p = u[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) l = p[o],
        ...
        trigger: function(n, r, i, o) {
            var s, a, u, c, l, f, p, d = [i || X],
            h = re.call(n, "type") ? n.type: n,
            g = re.call(n, "namespace") ? n.namespace.split(".") : [];
            if (a = u = i = i || X, 3 !== i.nodeType && 8 !== i.nodeType && !je.test(h + oe.event.triggered) && (h.indexOf(".") >= 0 && (g = h.split("."), h = g.shift(), g.sort()), l = h.indexOf(":") < 0 && "on" + h, n = n[oe.expando] ? n: new oe.Event(h, "object" == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = g.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : oe.makeArray(r, [n]), p = oe.event.special[h] || {},
            o || !p.trigger || p.trigger.apply(i, r) !== !1)) {
                if (!o && !p.noBubble && !oe.isWindow(i)) {
                    for (c = p.delegateType || h, je.test(c + h) || (a = a.parentNode); a; a = a.parentNode) d.push(a),
                    u = a;
                    u === (i.ownerDocument || X) && d.push(u.defaultView || u.parentWindow || e)
                }
                for (s = 0; (a = d[s++]) && !n.isPropagationStopped();) n.type = s > 1 ? c: p.bindType || h,
                f = (me.get(a, "events") || {})[n.type] && me.get(a, "handle"),
                f && f.apply(a, r),
                f = l && a[l],
                f && oe.acceptData(a) && f.apply && f.apply(a, r) === !1 && n.preventDefault();
                return n.type = h,
                o || n.isDefaultPrevented() || p._default && p._default.apply(d.pop(), r) !== !1 || !oe.acceptData(i) || l && oe.isFunction(i[h]) && !oe.isWindow(i) && (u = i[l], u && (i[l] = null), oe.event.triggered = h, i[h](), oe.event.triggered = t, u && (i[l] = u)),
                n.result
            }
        },
        dispatch: function(e) {
        ...
        handlers: function(e, n) {
            ...
            if (u && c.nodeType && (!e.button || "click" !== e.type)) for (; c !== this; c = c.parentNode || this) if (c.disabled !== !0 || "click" !== e.type) {
                ...
                o = s.selector + " ",
                i[o] === t && (i[o] = s.needsContext ? oe(o, this).index(c) >= 0 : oe.find(o, this, null, [c]).length),
                i[o] && i.push(s);
                i.length && a.push({
                    elem: c,
                    handlers: i
        ...
        mouseHooks: {
            ...
            filter: function(e, n) {
                ...
                return null == e.pageX && null != n.clientX && (r = e.target.ownerDocument || X, i = r.documentElement, o = r.body, e.pageX = n.clientX + (i && i.scrollLeft || o && o.scrollLeft || 0) - (i && i.clientLeft || o && o.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || o && o.scrollTop || 0) - (i && i.clientTop || o && o.clientTop || 0)),
        ...
        fix: function(e) {
            ...
            o = e,
            s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = Ne.test(i) ? this.mouseHooks: ke.test(i) ? this.keyHooks: {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t],
            e[n] = o[n];
    ...
    oe.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0,
            i = this.length,
            o = [], s = Ae.test(e) || "string" != typeof e ? oe(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && oe.find.matchesSelector(n, e))) {
                n = o.push(n);
                break
            }
    ...
    function(e, t) {
        oe.fn[e] = function(n, r) {
            ...
            this.length > 1 && (qe[e] || oe.unique(i), De.test(e) && i.reverse()),
            this.pushStack(i)
        }
    }),
    oe.extend({
    ...
    oe.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? oe.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || oe.cleanData(m(n)),
            n.parentNode && (t && oe.contains(n.ownerDocument, n) && h(m(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if ("string" == typeof e && !Fe.test(e) && !Be[(He.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i > r; r++) n = this[r] || {},
                        1 === n.nodeType && (oe.cleanData(m(n, !1)), n.innerHTML = e);
                        n = 0
                    } catch(o) {}
                }
        ...
        domManip: function(e, t, n) {
            ...
            g = e[0],
            y = oe.isFunction(g);
            if (y || !(1 >= l || "string" != typeof g || oe.support.checkClone) && Re.test(g)) return this.each(function(r) {
                var i = f.eq(r);
            ...
            if (l && (r = oe.buildFragment(e, this[0].ownerDocument, !1, !n && this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                for (o = oe.map(m(r, "script"), p), s = o.length; l > c; c++) a = r,
                c !== h && (a = oe.clone(a, !0, !0), s && oe.merge(o, m(a, "script"))),
                t.call(this[c], a, c);
                if (s) for (u = o[o.length - 1].ownerDocument, oe.map(o, d), c = 0; s > c; c++) a = o[c],
                Me.test(a.type || "") && !me.access(a, "globalEval") && oe.contains(u, a) && (a.src ? oe._evalUrl(a.src) : oe.globalEval(a.textContent.replace($e, "")))
            }
            return this
        }
    }),
    ...
    oe.extend({
        clone: function(e, t, n) {
            ...
            return s = m(a, "script"),
            s.length > 0 && h(s, !u && m(e, "script")),
            a
        },
        buildFragment: function(e, t, n, r) {
            for (var i, o, s, a, u, c, l = 0,
            f = e.length,
            p = t.createDocumentFragment(), d = []; f > l; l++) if (i = e[l], i || 0 === i) if ("object" === oe.type(i)) oe.merge(d, i.nodeType ? [i] : i);
            else if (Oe.test(i)) {
                for (o = o || p.appendChild(t.createElement("div")), s = (He.exec(i) || ["", ""])[1].toLowerCase(), a = Be[s] || Be._default, o.innerHTML = a[1] + i.replace(Le, "<$1></$2>") + a[2], c = a[0]; c--;) o = o.lastChild;
                oe.merge(d, o.childNodes),
                o = p.firstChild,
                o.textContent = ""
            } else d.push(t.createTextNode(i));
            for (p.textContent = "", l = 0; i = d[l++];) if ((!r || -1 === oe.inArray(i, r)) && (u = oe.contains(i.ownerDocument, i), o = m(p.appendChild(i), "script"), u && h(o), n)) for (c = 0; i = o[c++];) Me.test(i.type || "") && n.push(i);
            return p
        },
        cleanData: function(e) {
            for (var n, r, o, s, a, u, c = oe.event.special,
            l = 0; (r = e[l]) !== t; l++) {
                if (i.accepts(r) && (a = r[me.expando], a && (n = me.cache[a]))) {
                    if (o = Object.keys(n.events || {}), o.length) for (u = 0; (s = o[u]) !== t; u++) c[s] ? oe.event.remove(r, s) : oe.removeEvent(r, s, n.handle);
    ...
    oe.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                c = e.style;
                return n = oe.cssProps[u] || (oe.cssProps[u] = v(c, u)),
                a = oe.cssHooks[n] || oe.cssHooks[u],
                r === t ? a && "get" in a && (o = a.get(e, !1, i)) !== t ? o: c[n] : (s = typeof r, "string" === s && (o = Qe.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(oe.css(e, n)), s = "number"), null == r || "number" === s && isNaN(r) || ("number" !== s || oe.cssNumber[u] || (r += "px"), oe.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (c[n] = "inherit"), a && "set" in a && (r = a.set(e, r, i)) === t || (c[n] = r)), void 0)
            }
        },
        css: function(e, n, r, i) {
            var o, s, a, u = oe.camelCase(n);
            return n = oe.cssProps[u] || (oe.cssProps[u] = v(e.style, u)),
            a = oe.cssHooks[n] || oe.cssHooks[u],
            a && "get" in a && (o = a.get(e, !0, r)),
            o === t && (o = Ie(e, n, i)),
            "normal" === o && n in Ze && (o = Ze[n]),
            "" === r || r ? (s = parseFloat(o), r === !0 || oe.isNumeric(s) ? s || 0 : o) : o
        }
    }),
    Ie = function(e, n, r) {
        var i, o, s, a = r || b(e),
        ...
        c = e.style;
        return a && ("" !== u || oe.contains(e.ownerDocument, e) || (u = oe.style(e, n)), Ye.test(u) && Xe.test(n) && (i = c.width, o = c.minWidth, s = c.maxWidth, c.minWidth = c.maxWidth = c.width = u, u = a.width, c.width = i, c.minWidth = o, c.maxWidth = s)),
        u
    },
    ...
    function(e, t) {
        oe.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? 0 === e.offsetWidth && ze.test(oe.css(e, "display")) ? oe.swap(e, Ge,
                function() {
                    return k(e, t, r)
                }) : k(e, t, r) : void 0
            },
    ...
    oe(function() {
        ...
        !oe.support.pixelPosition && oe.fn.position && oe.each(["top", "left"],
        function(e, t) {
            oe.cssHooks[t] = {
                get: function(e, n) {
    ...
    function(e, t) {
        oe.cssHooks[e + t] = {
            expand: function(n) {
                for (var r = 0,
                i = {},
                o = "string" == typeof n ? n.split(" ") : [n]; 4 > r; r++) i[e + Je[r] + t] = o[r] || o[r - 2] || o[0];
                return i
            }
        },
    ...
    oe.param = function(e, n) {
        ...
        if (n === t && (n = oe.ajaxSettings && oe.ajaxSettings.traditional), oe.isArray(e) || e.jquery && !oe.isPlainObject(e)) oe.each(e,
        function() {
    ...
    ot = gt.exec(st.toLowerCase()) || [],
    oe.fn.load = function(e, n, r) {
        if ("string" != typeof e && mt) return mt.apply(this, arguments);
        var i, o, s, a = this,
        u = e.indexOf(" ");
        return u >= 0 && (i = e.slice(u), e = e.slice(0, u)),
        oe.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (o = "POST"),
        a.length > 0 && oe.ajax({
            url: e,
            type: o,
            dataType: "html",
    ...
    oe.extend({
        ...
        ajax: function(e, n) {
            function r(e, n, r, a) {
                var c, f, v, x, w, C = n;
                2 !== b && (b = 2, u && clearTimeout(u), i = t, s = a || "", T.readyState = e > 0 ? 4 : 0, c = e >= 200 && 300 > e || 304 === e, r && (x = q(p, T, r)), x = L(p, x, T, c), c ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = T.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === e || "HEAD" === p.type ? C = "nocontent": 304 === e ? C = "notmodified": (C = x.state, f = x.data, v = x.error, c = !v)) : (v = C, (e || !C) && (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (n || C) + "", c ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, v]), T.statusCode(y), y = t, l && h.trigger(c ? "ajaxSuccess": "ajaxError", [T, p, c ? f: v]), m.fireWith(d, [T, C]), l && (h.trigger("ajaxComplete", [T, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e, e = t),
            n = n || {};
            var i, o, s, a, u, c, l, f, p = oe.ajaxSetup({},
            n),
            d = p.context || p,
            ...
            if (g.promise(T).complete = m.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || st) + "").replace(ct, "").replace(ht, ot[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(ae) || [""], null == p.crossDomain && (c = gt.exec(p.url.toLowerCase()), p.crossDomain = !(!c || c[1] === ot[1] && c[2] === ot[2] && (c[3] || ("http:" === c[1] ? "80": "443")) === (ot[3] || ("http:" === ot[1] ? "80": "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), D(yt, p, n, T), 2 === b) return T;
            l = p.global,
            l && 0 === oe.active++&&oe.event.trigger("ajaxStart"),
            p.type = p.type.toUpperCase(),
            p.hasContent = !dt.test(p.type),
            o = p.url,
            p.hasContent || (p.data && (o = p.url += (ut.test(o) ? "&": "?") + p.data, delete p.data), p.cache === !1 && (p.url = lt.test(o) ? o.replace(lt, "$1_=" + at++) : o + (ut.test(o) ? "&": "?") + "_=" + at++)),
    ...
    function(e, n) {
        oe[n] = function(e, r, i, o) {
            return oe.isFunction(r) && (o = o || i, i = r, r = t),
            oe.ajax({
                url: e,
                type: n,
                dataType: o,
    ...
    oe.support.cors = !!Ct && "withCredentials" in Ct,
    oe.support.ajax = Ct = !!Ct,
    oe.ajaxTransport(function(e) {
        ...
        return oe.support.cors || Ct && !e.crossDomain ? {
            send: function(r, i) {
                ...
                n = function(e) {
                    return function() {
                        n && (delete jt[s], n = a.onload = a.onerror = null, "abort" === e ? a.abort() : "error" === e ? i(a.status || 404, a.statusText) : i(kt[a.status] || a.status, a.statusText, "string" == typeof a.responseText ? {
                            text: a.responseText
    ...
    oe.fn.extend({
        ...
        animate: function(e, t, n, r) {
            ...
            o = oe.speed(t, n, r),
            s = function() {
                var t = F(this, oe.extend({},
                e), o); (i || me.get(this, "finish")) && t.stop(!0)
            };
            return s.finish = s,
        ...
        stop: function(e, n, r) {
            ...
            this.each(function() {
                ...
                else for (n in s) s[n] && s[n].stop && qt.test(n) && i(s[n]);
                for (n = o.length; n--;) o[n].elem !== this || null != e && o[n].queue !== e || (o[n].anim.stop(r), t = !1, o.splice(n, 1)); (t || !r) && oe.dequeue(this, e)
            })
        },
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
    ...
    oe.fx.tick = function() {
        var e, n = oe.timers,
        r = 0;
        for (Et = oe.now(); r < n.length; r++) e = n[r],
    ...
    oe.fn.offset = function(e) {
        ...
        oe.contains(n, i) ? (typeof i.getBoundingClientRect !== _ && (o = i.getBoundingClientRect()), r = $(s), {
    ...
    oe.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, s, a, u, c, l = oe.css(e, "position"),
            f = oe(e),
            p = {};
    ...
    "object" == typeof module && module && "object" == typeof module.exports ? module.exports = oe: "function" == typeof define && define.amd && define("jquery", [],
    function() {
        return oe
    }),
...
function(e) {
    ...
    if (!e._ajax) {
        ...
        e._ajaxSettings = {
            ...
            dataType: "json",
            error: function(e, t) {
                e.defaultError && (t = "服务器出了点问题，请稍后再试 : (", n(t))
            }
        },
        e._ajax = function(t, n) {
            n = n || {},
            "object" == typeof t ? (n = t, t = void 0) : n.url = t,
            n = e.extend({},
            e._ajaxSettings, n);
            ...
            ["fail", "error"].forEach(function(e) {
                var t = i[e];
                "function" == typeof t && (i[e] = function(e) {
...
function(e) {
    ...
    function n(e, t) {
        var n, r, i, o, s, a, u, c, l, f, p, d = t && t.split("/"),
        h = g.map,
        m = h && h["*"] || {};
        if (e && "." === e.charAt(0)) if (t) {
            for (d = d.slice(0, d.length - 1), e = e.split("/"), s = e.length - 1, g.nodeIdCompat && x.test(e[s]) && (e[s] = e[s].replace(x, "")), e = d.concat(e), l = 0; l < e.length; l += 1) if (p = e[l], "." === p) e.splice(l, 1),
            l -= 1;
            else if (".." === p) {
        ...
        if ((d || m) && h) {
            for (n = e.split("/"), l = n.length; l > 0; l -= 1) {
                if (r = n.slice(0, l).join("/"), d) for (f = d.length; f > 0; f -= 1) if (i = h[d.slice(0, f).join("/")], i && (i = i[r])) {
                    o = i,
                    a = l;
                    break
                }
                if (o) break; ! u && m && m[r] && (u = m[r], c = l)
            } ! o && u && (o = u, a = c),
    ...
    f = function(e, t) {
        ...
        return e = o[1],
        u && (u = n(u, t), r = s(u)),
        u ? e = r && r.normalize ? r.normalize(e, i(t)) : n(e, t) : (e = n(e, t), o = a(e), u = o[0], e = o[1], u && (r = s(u))),
        {
            f: u ? u + "!" + e: e,
            n: e,
            pr: u,
    ...
    c = function(n, i, a, u) {
        ...
        if (u = u || n, "undefined" === w || "function" === w) {
            for (i = !i.length && a.length ? ["require", "exports", "module"] : i, v = 0; v < i.length; v += 1) if (y = f(i[v], u), l = y.f, "require" === l) b[v] = p.require(n);
            else if ("exports" === l) b[v] = p.exports(n),
            x = !0;
            else if ("module" === l) c = b[v] = p.module(n);
            else if (t(d, l) || t(h, l) || t(m, l)) b[v] = s(l);
            else {
                if (!y.p) throw new Error(n + " missing " + l);
                y.p.load(y.n, r(u, !0), o(l), {}),
                b[v] = d[l]
            }
            g = a ? a.apply(d[n], b) : void 0,
            n && (c && c.exports !== e && c.exports !== d[n] ? d[n] = c.exports: g === e && x || (d[n] = g))
        } else n && (d[n] = a)
    },
    requirejs = require = l = function(t, n, r, i, o) {
        if ("string" == typeof t) return p[t] ? p[t](n) : s(f(t, n).f);
        if (!t.splice) {
            if (g = t, g.deps && l(g.deps, g.callback), !n) return;
