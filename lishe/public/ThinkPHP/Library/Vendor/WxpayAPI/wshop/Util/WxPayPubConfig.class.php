...
class WxPayConf_pub
{
	...
	const JS_API_CALL_URL = 'http://www.lishe.cn/wshop.php?c=Pay&a=wxpay';
	//用于线下推广
	const JS_API_CALL_URL_EXTENSION = 'http://www.lishe.cn/wshop.php?c=Extension&a=wxpay';
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	const SSLCERT_PATH = '';
	const SSLKEY_PATH = '';
	...
	const NOTIFY_URL = 'http://www.lishe.cn/wshop.php/Index/asyNotify';
	//=======【curl超时设置】===================================
