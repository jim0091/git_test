...
//默认加载售价和积分价
// var defCash = $("#size div").children("input.skuCash").val();
// var defPoint = $("#size div").children("input.skuPoint").val();
// if (defCash == '0.000' &&  defPoint == '0' ) {
// 	$(".tdTitle").text("福利积分：");
// 	$(".skuCashPoint").text(defIntegral);
// 	$(".jifen").text("积分");
// }else if(defCash == '0.000' && defPoint != '0'){
// 	$(".tdTitle").html("积&nbsp;&nbsp;&nbsp;&nbsp;分：");
// 	$(".skuCashPoint").text(defPoint);
// 	$(".jifen").text("积分");
// }else if(defPoint == '0' && defCash != '0.000'){
// 	$(".tdTitle").html("现&nbsp;&nbsp;&nbsp;&nbsp;金：");
// 	$(".skuCashPoint").text("￥"+parseFloat(defCash).toFixed(2));
// }else{
// 	$(".tdTitle").text("现金+积分：");
// 	$(".skuCashPoint").text("￥"+parseFloat(defCash).toFixed(2)+"+"+defPoint);
// 	$(".jifen").text("积分");
// }
...
function checkStore(){
	...
	if (shopId != 10) {
	    ...
	    $.get("/api.php/Jd/checkJdStock/item_id/"+item_id+"/jd_ids/"+jd_ids+"/num/"+number.value, function(retData){
	    	if(retData==33){
				var msg='有货';
				$("#size div").bind("click");
				$('#add_to_cart').show();
