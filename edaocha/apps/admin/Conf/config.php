    ...
    'admin_menu' => array(
        ...
        'system' => array(
            L('PUBLIC_SYSTEM_SETTING') => array(
                ...
                '水印配置' => U('admin/Config/waterMark'),
                '活动配置' => U('admin/Config/setEvent'),
        ...
        'user' => array(
            L('PUBLIC_USER') => array(
                ...
                '邀请码管理'                            => U('admin/RegisterCode/index'),
                '抽奖管理'                            => U('admin/LuckDraw/index'),
                '用户备注'                            => U('admin/User/state'),
            ),
        ),
        ...
        'content' => array(
            L('PUBLIC_CONTENT_MANAGEMENT') => array(
                ...
                '分享统计管理'                             => U('admin/Content/feed_manage'),
                '评论点赞统计管理'                             => U('admin/Content/comment_digg_manage'),
                ...
                '群聊管理'                                 => U('admin/Content/message_list'),
                '奥豆视频管理'     => U('admin/Content/aodou_video'),
                '关键词搜索管理'     => U('admin/KeywordStatistic/index'),
        ...
        'application' => array(
            'seting' => array(
                ...
                '行为规范'     => U('admin/Application/privacy'),
                '反馈管理'     => U('admin/Application/feedback'),
                '提现管理'     => U('admin/Application/ZB_credit_order'),
                'app系统推送'  => U('admin/Application/messageSystem'),
                'IOS&安卓版本管理'     => U('admin/Application/version_manage'),
                'IOS&安卓链接管理'     => U('admin/Config/appLink'),
                '匿名库管理'     => U('admin/Application/anonymous_category'),
            ),
        ),
    ),
);
