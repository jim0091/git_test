...
class Access extends Service
{
    ...
    protected function _beforeAction()
    {
        $this
            ...
            ->add('event', 'getEventList')
            ->add('event','getEventInfo')

            ->add('video', 'getVideoData')

            ->add('information', 'getInformationNav')
            ->add('information', 'getInformationInfo')
            ->add('information', 'getInformationList');
