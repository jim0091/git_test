...
class UserShow extends Component
{
  constructor(props) {
    ...
    this.userInfoCacheName = 'user-show-' + props.params.uid;
  }
  ...
  componentDidMount() {
    if (Cache.hasItem(this.userInfoCacheName) && this.state.isCache == true) {
  ...
  render() {
    ...
    if (type != 'home' && type != 'feed' && type != 'photo' && type != 'collect') {
      type = 'feed';
    }
    return (
        ...
        <div style={styles.root}>
          ...
          >
            ...
            >
              ...
              {/*<div style={styles.itemBox}>
                <div
                  style={styles.itemHeader}
                  onTouchTap={() => {
                    this.context.router.push(`/user/collect`);
                  }}
                >
                  <span>收藏</span>
                  <NavigationChevronRight color={'#979797'} />
              ...
              <div style={styles.itemBox}>
                ...
                >
                  <span>关注</span>
                  <span style={styles.itemHeaderConter}>
                  {this.state.user.starUsers.length}
                  {/*this.state.user.starCount*/}</span>
                  <NavigationChevronRight color={'#979797'} />
                </div>
              ...
              <div style={styles.itemBox}>
                <div
                  style={styles.itemHeader}
                  onTouchTap={() => {
                    this.context.router.push(`/user/more/user/follower/${this.state.user.uid}/${encodeURI('粉丝')}`)
                  }}
                >
                  <span>粉丝</span>
                  <span style={styles.itemHeaderConter}>
                  {this.state.user.followUsers.length}
                  {/*this.state.user.followCount*/}</span>
                  <NavigationChevronRight color={'#979797'} />
                </div>
                <div style={styles.users}>
            ...
            <Tab
              ...
              onActive={() => {
                if (type != 'feed') {
                  this.context.router.replace(`/user/${this.state.user.uid}/feed`);
                }
              }}
            >
