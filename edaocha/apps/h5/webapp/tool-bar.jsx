  ...
  render() {
    return (
      ...
      >
        ...
        >
          <HomeIcon color={this.state.value == 'home' ? '#ff5b36' : '#9e9e9e'} />
        </IconButton>
        <IconButton
          onTouchTap={() => {
        ...
        >
          <ExploreIcon color={this.state.value == 'find' ? '#ff5b36' : '#9e9e9e'} />
        </IconButton>
        <IconButton
          iconStyle={{
            width: 40,
        ...
        >
          <MessageIcon color={this.state.value == 'message' ? '#ff5b36' : '#9e9e9e'} />
        </IconButton>
        <IconButton
          onTouchTap={() => {
        ...
        >
          <PersonIcon color={this.state.value == 'user' ? '#ff5b36' : '#9e9e9e'} />
        </IconButton>
      </div>
    );
  }
