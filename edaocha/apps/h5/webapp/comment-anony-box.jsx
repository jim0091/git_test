...
import CommentItem from './comment-anony-item.jsx';
...
class CommentBox extends React.Component
{
  ...
  componentWillUnmount() {
	...
	render() {
		...
		return (
			<List>
				<div style={styles.commentTop}>评论<p style={styles.comment}>共<span style={{color:'#ff5b36',fontSize:'12px'}}>{this.state.commentNum}条</span>评论</p></div>
