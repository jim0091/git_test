...
class User extends Component
{
  ...
  componentDidMount() {
    ...
    } else if (Cache.hasItem('user-data-info') && this.state.isCache == true) {
    ...
    return (
      <MuiThemeProvider muiTheme={muiTheme}>
        <div style={styles.root}>
          <AppBar
            title={<h1 style={styles.center}>我</h1>}
          ...
          >
            <ListItem
              ...
              onTouchTap={this.handlePushPath.bind(this, '/user/' + this.state.user.uid)}
            />
          </List>
          <Divider />
