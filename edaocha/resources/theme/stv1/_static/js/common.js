	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="topcontrol">'+mainobj.controlHTML+'</div>')
				.css({position:mainobj.cssfixedsupport? 'fixed' : 'absolute', bottom:mainobj.controlattrs.offsety-1+"px", right:mainobj.controlattrs.offsetx, opacity:0, cursor:'pointer'})
				.css('right', '70px')
